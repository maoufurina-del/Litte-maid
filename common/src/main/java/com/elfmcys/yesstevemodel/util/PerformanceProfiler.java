...
public final class PerformanceProfiler {
    ...
    public static void logElapsed(String stage, String modelId, long startNanos, String details) {
        ...
        if (details == null || details.isBlank()) {
            YesSteveModel.LOGGER.info("[YSM][Perf] {} model={} elapsed={} ms", stage, safe(modelId), elapsedMs);
        } else {
            YesSteveModel.LOGGER.info("[YSM][Perf] {} model={} elapsed={} ms {}", stage, safe(modelId), elapsedMs, details);
        }
    }
